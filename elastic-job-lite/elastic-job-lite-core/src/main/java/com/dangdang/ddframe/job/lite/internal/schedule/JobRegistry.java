...
public final class JobRegistry {
    ...
    //TODO("XIONGSL")
    private Map<String, String> jobCronMap = new ConcurrentHashMap<>();
...
//        regCenter.addCacheData("/" + jobName);
    ...
    //TODO("XIONGSL")
    public void addRegCenter(String jobName, CoordinatorRegistryCenter regCenter) {
    ...
    public void setJobCron(String jobName, String cron) {
