 ...
 */
@Slf4j
public final class DefaultJobEventBus implements JobEventBus {
    ...
    public DefaultJobEventBus() {
        jobEventConfig = null;
        executorServiceObject = null;
        eventBus = null;
    }
    
    public DefaultJobEventBus(final JobEventConfiguration jobEventConfig) {
