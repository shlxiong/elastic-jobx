...
public final class JobExecutionEvent implements JobEvent {
    ...
    public JobExecutionEvent executionSuccess() {
    	//TODO("XIONGSL")
        return new JobExecutionEvent(id, hostname, ip, taskId, jobName, source, shardingItem, startTime,
        				new Date(), true, null, contextId);
    }
    ...
    public JobExecutionEvent executionFailure(final Throwable failureCause) {
    	//TODO("XIONGSL")
        return new JobExecutionEvent(id, hostname, ip, taskId, jobName, source, shardingItem, startTime, 
        				new Date(), false, new JobExecutionEventThrowable(failureCause), contextId);
    }
